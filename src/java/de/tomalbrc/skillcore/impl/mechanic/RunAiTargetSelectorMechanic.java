...
public class RunAiTargetSelectorMechanic extends AbstractMechanic {
            ...
            for (Target target : t) {
                SkillCore.SERVER.execute(() -> {
                    if (target.getEntity() instanceof PathfinderMob mob) {
                        var goalSelector = ((MobAccessor)mob).getTargetSelector();
    ...
    public ResourceLocation id() {
        return Mechanics.RUN_AI_TARGET_SELECTOR;
    }
}