...
public abstract class EntityHolder<T extends Entity> extends AbstractAnimationHolder implements AnimatedEntityHolder {
    protected final ObjectOpenHashSet<DisplayElement> additionalDisplays;
    protected final T parent;
    protected EntityDimensions dimensions;
    protected int tickCount;

    final Set<Bone> forceHiddenBones = new HashSet<>();
    ...
    protected void updateInvisibility(boolean isInvisible) {
        for (Bone bone : this.bones) {
            if (!forceHiddenBones.contains(bone))
